    ...
    */
    async playerCreation(data, id)
    {
        try
        {
            ...
            else if(data[2] == "démon") stat.hp.push(0.9), stat.magie.push(1), stat.attaque.push(1.1), stat.armure.push(1)
            ...
            else if(data[2] == "liche") stat.hp.push(0.75), stat.magie.push(1.2), stat.attaque.push(1), stat.armure.push(1.05)
